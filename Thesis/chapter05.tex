...
\todo{Include results of default resources estimator in this section or consider showing the results, explanation and analysys in a separate chapter (preferred).}
